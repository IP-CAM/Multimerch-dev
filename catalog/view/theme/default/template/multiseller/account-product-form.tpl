    ...
    <h1><?php echo $heading; ?></h1>
		...
		<div class="tab-content ms-product">
     	<div id="tab-general" class="tab-pane active">
			...
			foreach ($languages as $k => $language) {
				...
				<div class="ms-language-div tab-pane <?php if ($k == $first) { echo 'active'; } ?>" id="language<?php echo $langId; ?>">
					...
					<div class="form-group">
						<label class="mm_label"><?php echo $ms_account_product_meta_description; ?></label>
						<div class="mm_form">
							<!-- todo strip tags if rte disabled -->
					...
					<div class="form-group">
						<label class="mm_label"><?php echo $ms_account_product_tags; ?></label>
						<div class="mm_form">
				...
				<div class="form-group <?php if ($attr['required']) { echo 'required'; } ?>">
					<label class="mm_label"><?php echo $attr['name']; ?></label>
					<div class="mm_form">
			...
			<fieldset>
				<h4><?php echo $ms_account_product_message_reviewer; ?></h4>

				<div class="form-group">
					<label class="mm_label"><?php echo $ms_account_product_message; ?></label>
					<div class="mm_form">
        ...
        <div id="tab-data" class="tab-pane">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_sku; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_jan; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_isbn; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_mpn; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_manufacturer; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_tax_class; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_subtract; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_stock_status; ?></label>
				<div class="mm_form">
			...
			<div class="form-group required">
				<label class="mm_label"><?php echo $ms_account_product_date_available; ?></label>
				<div class="mm_form"><input type="text" class="form-control" name="product_date_available" value="<?php echo $date_available; ?>" size="12" class="date" /></div>
			</div>
			<?php } ?>

			<?php if (in_array('filters', $this->config->get('msconf_product_included_fields'))) { ?>
			<div class="form-group">
				<label class="mm_label" for="input-filter"><span data-toggle="tooltip"><?php echo $this->language->get('ms_entry_filter'); ?></span></label>
				<div class="mm_form">
