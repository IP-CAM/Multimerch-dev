      ...
      <div class="row product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>">
          ...
          <ul id="tabs" class="nav nav-tabs htabs">
            ...
            <?php } ?>
				...
				<?php foreach ($ms_product_attributes as $attribute) { ?>
					...
					<li <?php if ($is_active) { echo 'class="active"'; $is_active = false; } ;?>><a data-toggle="tab" href="#tab-attribute-<?php echo $attribute['attribute_id']; ?>"><?php echo $attribute['name'] ?></a></li>
					<?php } ?>
				<?php } ?>
          ...
          <div class="tabs-content">
            ...
            <?php } ?>
				...
				<?php foreach ($ms_product_attributes as $attribute) { ?>
					...
					<div id="tab-attribute-<?php echo $attribute['attribute_id']; ?>" class="tab-pane tab-content <?php if ($is_active) { echo 'active'; $is_active = false; } ;?>">
        ...
        <div class="right">
          ...
          <?php } ?>
			...
			<hr />
			<div class="multimerch_product">
            <div class="mm_block">
              <h4>Seller information</h4>
              <div class="mm_avatar"></div>
              <div class="mm_user"><a href="">gerrenlamson</a></div>
              <div class="mm_locate">Sokolniki, Moscow</div>
              <div class="mm_rating">
                <span class="yellow"></span><span class="yellow"></span><span class="yellow"></span><span></span><span></span>
              </div>
              <div class="mm_social">
                <a class="mm_facebook_mini" href=""></a><a href="" class="mm_twitter_mini"></a><a href="" class="mm_google_mini"></a><div class="cl"></div>
              </div>
              <div class="mm_button"><button type="button" id="button-cart" data-loading-text="Loading..." class="btn btn-primary">Contact Seller</button></div>
              <div class="mm_load"><a href="">See other items</a></div>
              <div class="cl"></div>
            </div>
