                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                  ...
                  <?php } else { ?>   
                    ...
                    <?php if (isset($is_home)) { ?>
                      <?php if ($layout_module['position'] == 'home_top_full') { ?>
                      <option value="home_top_full" selected="selected">Home RevSlider</option>
                      <?php } else { ?>
                      <option value="home_top_full">Home RevSlider</option>
                      <?php } ?>
                    <?php } ?>
...
function addModule() {
  ...
  <?php } else { ?>
  <?php if (isset($is_home)) { ?>
  html += '    <option value="home_top_full">Home Top Full Width</option>';
  <?php } ?>
