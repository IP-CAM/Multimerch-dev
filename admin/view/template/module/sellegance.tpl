			                ...
			                <div class="col-sm-10">
			                	...
			                	<div class="col-sm-10">
				                	...
				                	<div class="col-sm-10">
				                		...
				                		<span class="help-block"><b>Default</b> Normal:<code>#000000</code>, Hover:<code>#DD4B39</code></span>
				                	</div>
											</div>
			                	...
			                	<div class="col-sm-10">
			                		...
			                		<span class="customhelp">Background on hover:</span> <input type="text" name="sellegance_dropdown_hover" value="<?php echo $sellegance_dropdown_hover; ?>" size="6" class="color {required:false,hash:true}" />
			                		<span class="help-block"><b>Default</b> Normal:<code>#333333</code>, Hover:<code>#2e2e2e</code></span>
			                	</div>
											</div>
										...
										<fieldset id="colors-buttons">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<span class="help-block"><b>Default</b> Normal:<code>#DD4B39</code>, Hover:<code>#D14836</code>, Text:<code>#FFFFFF</code></span>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<span class="help-block"><b>Default</b> Normal:<code>#363636</code>, Hover:<code>#191919</code>, Text:<code>#FFFFFF</code></span>
												</div>
											</div>
										...
										<fieldset id="colors-products">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<span class="help-block"><b>Default</b> Normal:<code>#FF3B40</code>, Text:<code>#FFFFFF</code></span>
												</div>
											</div>
								...
								<div class="tab-pane fade" id="design-background">
									...
									<fieldset>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="sellegance_skins"><?php echo $entry_pattern_overlay; ?></label>
											<div class="col-sm-10">
												<div>
													<?php for ($i = 1; $i <= 42; $i++) { ?>
							...
							<div class="tab-content">
							                ...
							                <div class="col-sm-10">
							                	<div class="row">
								                	<div class="col-sm-3">
														...
														<?php $language_id=$language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_categories_tag[<?php echo $language_id; ?>]" id="sellegance_brands_tag_<?php echo $language_id; ?>" value="<?php echo $sellegance_categories_tag[$language_id]; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
														<?php } ?>
													</div>
							                ...
							                <div class="col-sm-10">
							                	<div class="row">
								                	<div class="col-sm-3">
														...
														<?php $language_id=$language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_brands_tag[<?php echo $language_id; ?>]" id="sellegance_brands_tag_<?php echo $language_id; ?>" value="<?php echo $sellegance_brands_tag[$language_id]; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
														<?php } ?>
													</div>
												...
												<tbody>
										            ...
										            <div class="btn-group btn-toggle" data-toggle="buttons">
														...
														<td>
															...
															<div class="input-group">
																<input type="text" name="sellegance_menu_link[<?php echo $i; ?>][<?php echo $language_id; ?>][title]" id="sellegance_menu_link_<?php echo $i; ?>_<?php echo $language_id; ?>_title" value="<?php echo $sellegance_menu_link[$i][$language_id]['title']; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
															<?php } ?>
														</td>
														<td>
															...
															<?php $language_id = $language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_menu_link[<?php echo $i; ?>][<?php echo $language_id; ?>][url]" id="sellegance_menu_link_<?php echo $i; ?>_<?php echo $language_id; ?>_url" value="<?php echo $sellegance_menu_link[$i][$language_id]['url']; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
															<?php } ?>
														</td>
									...
									<fieldset>
										...
										<div class="form-group">
							                ...
							                <div class="col-sm-10">
												...
												<?php $language_id=$language['language_id']; ?>
													<div class="input-group">
														<input type="text" name="sellegance_menu_dropdown_title[<?php echo $language_id; ?>]" id="sellegance_menu_dropdown_title_<?php echo $language_id; ?>" value="<?php echo $sellegance_menu_dropdown_title[$language_id]; ?>" class="form-control" />
														<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
													</div>
												<?php } ?>
							                </div>
							                ...
							                <div class="col-sm-10">
							                	<div class="row">
								                	<div class="col-sm-3">
														...
														<?php $language_id=$language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_menu_dropdown_tag[<?php echo $language_id; ?>]" id="sellegance_menu_dropdown_tag_<?php echo $language_id; ?>" value="<?php echo $sellegance_menu_dropdown_tag[$language_id]; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
														<?php } ?>
													</div>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<div class="input-group">
																<input type="text" name="sellegance_menu_dropdown[<?php echo $i; ?>][<?php echo $language_id; ?>][title]" id="sellegance_menu_dropdown_<?php echo $i; ?>_<?php echo $language_id; ?>_title" value="<?php echo $sellegance_menu_dropdown[$i][$language_id]['title']; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
								...
								<div class="tab-pane" id="menu-blocks">
									...
									<fieldset>
										...
										<legend><?php echo $entry_menu_block_sub; ?></legend>

										<div class="form-group">
							                <label class="col-sm-2 control-label"><?php echo 'Show custom blocks menu' ?></label>
							                <div class="col-sm-10">
							                	<div class="btn-group btn-toggle" data-toggle="buttons">
													<?php if($sellegance_custom_block_status == 1) { ?>
														<label class="btn btn-success btn-sm active">
															<input type="radio" name="sellegance_custom_block_status" value="1" checked="checked">ON
														</label>
														<label class="btn btn-default btn-sm">
															<input type="radio" name="sellegance_custom_block_status" value="0">OFF
														</label>
													<?php } else { ?>
														<label class="btn btn-default btn-sm">
															<input type="radio" name="sellegance_custom_block_status" value="1">ON
														</label>
														<label class="btn btn-success btn-sm active">
															<input type="radio" name="sellegance_custom_block_status" value="0" checked="checked">OFF
														</label>
													<?php } ?>
												</div>
							                </div>
										...
										<div class="form-group">
							                ...
							                <div class="col-sm-10">
												...
												<?php $language_id=$language['language_id']; ?>
													<div class="input-group">
														<input type="text" name="sellegance_custom_block_title[<?php echo $language_id; ?>]" id="sellegance_custom_block_title_<?php echo $language_id; ?>" value="<?php echo $sellegance_custom_block_title[$language_id]; ?>" class="form-control" />
														<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
													</div>
												<?php } ?>
							                </div>
							                ...
							                <div class="col-sm-10">
							                	<div class="row">
								                	<div class="col-sm-3">
														...
														<?php $language_id=$language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_custom_block_tag[<?php echo $language_id; ?>]" id="sellegance_custom_block_tag_<?php echo $language_id; ?>" value="<?php echo $sellegance_custom_block_tag[$language_id]; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
														<?php } ?>
													</div>
										...
										<?php for ($i = 1; $i <= 4; $i++) { ?>
											...
											<div class="form-group">
								                <label class="col-sm-2 control-label"><?php echo $entry_menu_block_show.' '.$i; ?></label>
								                <div class="col-sm-10">
								                	<div class="btn-group btn-toggle" data-toggle="buttons">
														<?php if($sellegance_custom_block[$i]['status'] == 1) { ?>
															<label class="btn btn-success btn-sm active">
																<input type="radio" name="sellegance_custom_block[<?php echo $i ?>][status]" value="1" checked="checked">ON
															</label>
															<label class="btn btn-default btn-sm">
																<input type="radio" name="sellegance_custom_block[<?php echo $i ?>][status]" value="0">OFF
															</label>
														<?php } else { ?>
															<label class="btn btn-default btn-sm">
																<input type="radio" name="sellegance_custom_block[<?php echo $i ?>][status]" value="1">ON
															</label>
															<label class="btn btn-success btn-sm active">
																<input type="radio" name="sellegance_custom_block[<?php echo $i ?>][status]" value="0" checked="checked">OFF
															</label>
														<?php } ?>
													</div><br /><br />
								                
											
													<ul id="custom_block_<?php echo $i; ?>" class="nav nav-tabs">
														<?php foreach ($languages as $language) { ?>
															<li><a href="#custom_block_<?php echo $i; ?>_<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" /> <?php echo $language['name']; ?></a></li>
														<?php } ?>
													</ul>
													...
													<div class="tab-content">
														...
														<?php foreach ($languages as $language) { ?>
															...
															<div id="custom_block_<?php echo $i; ?>_<?php echo $language_id; ?>" class="tab-pane">
																<textarea name="sellegance_custom_block[<?php echo $i ?>][<?php echo $language_id; ?>][content]" id="sellegance_custom_block_<?php echo $i ?>_<?php echo $language_id; ?>_content" cols="52" rows="5" class="ckeditor"><?php echo $sellegance_custom_block[$i][$language_id]['content']; ?></textarea>
															</div>

															<script type="text/javascript">
																<?php foreach ($languages as $language) { ?>
																$('#sellegance_custom_block_<?php echo $i ?>_<?php echo $language_id; ?>_content').summernote({height: 300});
																<?php } ?>

																$('#custom_block_<?php echo $i; ?> li:first-child a').tab('show');
															</script>
		    		                ...
		    		                <div class="col-sm-10">
		    		                	...
		    		                	<div class="row">
						                	<div class="col-sm-3">
														...
														<?php $language_id=$language['language_id']; ?>
															<div class="input-group">
																<input type="text" name="sellegance_infopages_tag[<?php echo $language_id; ?>]" id="sellegance_infopages_tag_<?php echo $language_id; ?>" value="<?php echo $sellegance_infopages_tag[$language_id]; ?>" class="form-control" />
																<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
															</div>
														<?php } ?>
													</div>
										...
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
												...
												<div id="sellegance_header_info_text_<?php echo $language_id; ?>" class="tab-pane">
													<textarea name="sellegance_header_info_text[<?php echo $language_id; ?>]" id="sellegance_header_info_text-<?php echo $language_id; ?>" ><?php if(isset($sellegance_header_info_text[$language_id])) echo $sellegance_header_info_text[$language_id]; ?></textarea>
												</div>
										...
										<div class="tab-content">
											<?php foreach ($languages as $language) { ?>
												...
												<div id="sellegance_footer_info_text_<?php echo $language_id; ?>" class="tab-pane">
													<textarea name="sellegance_footer_info_text[<?php echo $language_id; ?>]" id="sellegance_footer_info_text-<?php echo $language_id; ?>" ><?php if(isset($sellegance_footer_info_text[$language_id])) echo $sellegance_footer_info_text[$language_id]; ?></textarea>
												</div>
